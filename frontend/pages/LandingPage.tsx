              ...
              <div 
                ...
                onClick={() => {
                  if (member.name === 'Farial Huda') {
                    onNavigate('farial');
                  } else if ((member as any).link) {
                    window.open((member as any).link, '_blank');
                  }
                }}
                style={{ cursor: ((member as any).link || member.name === 'Farial Huda') ? 'pointer' : 'default' }}
                title={(member as any).link || member.name === 'Farial Huda' ? `Voir le profil de ${member.name}` : ''}
              >
                {/* Avatar */}
