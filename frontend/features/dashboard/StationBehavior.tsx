    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <div className="grid grid-cols-1 gap-6 mb-8">
        ...
        <Card className="p-6 border-0 shadow-md">
          <h3 className="text-lg font-bold text-gray-900 mb-2">Analyse Temporelle 24h</h3>
        ...
        {/* Weekly Pattern */}
        <Card className="p-6 border-0 shadow-md">
          <h3 className="text-lg font-bold text-gray-900 mb-2">Motif Hebdomadaire</h3>
        ...
        <Card className="p-6 border-0 shadow-md">
          <h3 className="text-lg font-bold text-gray-900 mb-2">Tendance Mensuelle</h3>
